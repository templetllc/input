                            ...
                            <div class="col-12 p-0">
                                <form class="active" data-type="onedrive">
                                    <div class="row">
                                        <!-- <div class="col-12 col-md-12 p-0">
                                            <div class="mb-3">
                                                ...
                                                <input type="url" class="form-control" id="onedrive_link" name="onedrive_link" aria-describedby="" placeholder="https://templetllc-my.sharepoint.com/…" required data-type="onedrive">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-12 p-0">
                                            <div class="mb-3">
                                                <label for="adobe_link" class="form-label">Adobe link</label>
                                                <input type="url" class="form-control" id="adobe_link" name="adobe_link" data-type="adobe" aria-describedby="" placeholder="https://templetllc-my.sharepoint.com/…" required>
                                                <span class="error_adobe_link error">Mensaje de Error</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-12 p-0">
                                            <div class="mb-3">
                                                ...
                                                <input type="url" class="form-control" id="loom_link" name="loom_link" aria-describedby="" placeholder="https://loom.com/share/…" data-type="loom">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-12 p-0">
                                            <div class="file-upload-contain">
                                                ...
                                                <input id="fileupload" name="fileupload" type="file" accept=".zip" data-type="file" required />
                                            </div>
