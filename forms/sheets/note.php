                        ...
                        <div class="row justify-content-center pb-2">
                            <div class="col-12 p-0">
                                <form class="active" data-type="onedrive">  
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-12 p-0">
                                            <div class="mb-3">
                                                ...
                                                <input type="url" class="form-control valuable" id="loom_link" name="loom_link" data-type="loom" aria-describedby="" placeholder="https://loom.com/share/…">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-12 p-0 prueba">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-12 p-0">
                                            <div class="file-upload-contain">
                                                ...
                                                <input id="fileupload" name="fileupload" type="file" accept=".doc,.docx,.rft,.txt" required />
