                                ...
                                <form class="active" data-type="onedrive">  
                                    <div class="row">
                                        <div class="col-12 col-md-12 p-0">
                                            <div class="mb-3">
                                                <label for="" class="form-label">Notes link</label>
                                                <input type="url" class="form-control" id="evernote_link" name="evernote_link" aria-describedby="" placeholder="https://www.evernote.com/shard/…" required data-type="evernote">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-12 p-0">
                                            <div class="file-upload-contain">
                                                ...
                                                <input id="fileupload" name="fileupload" type="file" accept=".doc,.docx,.rft,.txt" data-type="file" required />
                                            </div>
