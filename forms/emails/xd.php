                                ...
                                <form class="active" data-type="onedrive">  
                                    <div class="row">
                                        <div class="col-12 col-md-12 p-0">
                                            <div class="mb-3">
                                                <label for="" class="form-label">Xd preview link</label>
                                                <input type="url" class="form-control valuable" id="xd_link" name="xd_link" data-type="xd" aria-describedby="" placeholder="https://xd.adobe.com/view/..." required>
                                                <span class="error_xd_link error">Mensaje de Error</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-md-12 p-0">
                                            <div class="file-upload-contain">
                                                ...
                                                <input id="fileupload" name="fileupload" type="file" accept=".xd" required />
