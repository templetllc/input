                                ...
                                <form class="active" data-type="onedrive">  
                                    <div class="row">
                                        <div class="col-12 col-md-12 p-0">
                                            <div class="mb-3">
                                                <label for="" class="form-label">email.templet link</label>
                                                <input type="url" class="form-control valuable" id="email_link" name="email_link" data-type="email" aria-describedby="" placeholder="https://email.templet.io/admin/builder/…." required>
                                                <span class="error_email_link error">Mensaje de Error</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <form data-type="file">
                                    <div class="row">
                                        <div class="col-12 col-md-12 p-0">
                                            <div class="mb-3">
                                                <label for="" class="form-label">email.templet link</label>
                                                <input type="url" class="form-control" id="email_link" name="email_link" data-type="email" aria-describedby="" placeholder="https://email.templet.io/admin/builder/…." required>
                                                <span class="error_email_link error">Mensaje de Error</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <!-- <div class="row justify-content-center">
                                        <div class="col-md-12 p-0">
                                            <div class="file-upload-contain">
                                                <label for="fileupload2" class="form-label">File</label>
                                                <input id="fileupload2" name="fileupload2" type="file" accept=".jpg,.gif,.png"  required/>
